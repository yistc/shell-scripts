...
curl -LO "https://github.com/ajeetdsouza/zoxide/releases/download/$tag_name/zoxide_${tag_name#v}-1_arm64.deb"
dpkg -i "zoxide_${tag_name#v}-1_arm64.deb"
rm "zoxide_${tag_name#v}-1_arm64.deb"
