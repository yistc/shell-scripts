...
# some basic packages
apt update -y
apt install sudo net-tools xz-utils lsb-release ca-certificates dnsutils dpkg mtr-tiny iperf3 pwgen zsh rsync unzip vim ripgrep git gnupg build-essential -y
